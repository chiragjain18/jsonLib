 ...
 * to configure a {@link JsonLib} instance to properly translate Java field
...
public enum FieldNamingPolicy implements FieldNamingStrategy {
  ...
  /**
   * Using this naming policy with JsonLib will ensure that the field name is
   * unchanged.
   */
  IDENTITY() {
  ...
  /**
   * Using this naming policy with JsonLib will ensure that the first "letter" of the Java
  ...
  /**
   * Using this naming policy with JsonLib will modify the Java Field name from its camel cased
