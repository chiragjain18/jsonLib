 ...
 * Basically, if JsonLib is created with a version number that exceeds the value stored in the
 ...
 * JsonLib with {@code JsonLib gson = new GsonBuilder().setVersion(1.2).create()} then the
 * {@code stringToJson()} and {@code fromJson()} methods of JsonLib will exclude the {@code emailAddress}
