 ...
 * multiset's type token. A {@code JsonLib} is passed in to {@code create} for
 * just this purpose: <pre>   {@code
 *
 *   public class MultisetTypeAdapterFactory implements TypeAdapterFactory {
 *     public <T> TypeAdapter<T> create(JsonLib gson, TypeToken<T> typeToken) {
 ...
 * the foundation of how JsonLib converts Java objects and collections. Whenever
...
public interface TypeAdapterFactory {
   ...
   * support {@code type}.
   */
  <T> TypeAdapter<T> create(JsonLib gson, TypeToken<T> type);
}
