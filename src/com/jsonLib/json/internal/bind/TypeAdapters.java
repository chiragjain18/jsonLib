...
import com.jsonLib.json.JsonIOException;
...
import com.jsonLib.json.JsonArray;
import com.jsonLib.json.JsonElement;
import com.jsonLib.json.JsonNull;
import com.jsonLib.json.JsonObject;
...
import com.jsonLib.json.internal.LazilyParsedNumber;
...
public final class TypeAdapters {
  ...
  public static <T1> TypeAdapterFactory newTypeHierarchyFactory(
    ...
    return new TypeAdapterFactory() {
      ...
      @Override public <T2> TypeAdapter<T2> create(JsonLib gson, TypeToken<T2> typeToken) {
